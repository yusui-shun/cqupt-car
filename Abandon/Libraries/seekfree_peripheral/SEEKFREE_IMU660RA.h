...
#else
//=====================================================软件 SPI 驱动====================================================
	#define IMU660RA_SPC_PIN            (P43)      	// 软件 SPI SCK 引脚
	#define IMU660RA_SDI_PIN            (P40)      	// 软件 SPI MOSI 引脚
	#define IMU660RA_SDO_PIN            (P41)      	// 软件 SPI MISO 引脚
	#define IMU660RA_CS_PIN             (P16)      	// 软件 SPI CS 引脚
//=====================================================软件 SPI 驱动====================================================
#endif
